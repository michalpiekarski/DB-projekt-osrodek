...
<html>
	<head>
		...
		<script type="text/javascript" src="/bazy/js/validation_rezerwacje_aktualne.js"></script>
	</head>
	<body>
		...
		<form id="rezerwacje_aktualne_klient_form" action='rezerwacje_aktualne.php' method='post' class='basic-grey'>
