...
<html>
	...
	<body>
		...
		<form id="zamowienia_aktualne_klient_form" action='zamowienia_aktualne.php' method='post' class='basic-grey'>
				...
				<h2>
					<div class="wizard-steps">
						...
						<div>
							<a><span>2</span> Aktualne zamówienia klienta</a>
						</div>
					</div>
				</h2>
			...
			<h2>
				<div class="wizard-steps">
					<div class="completed-step hoverable">
						<a href="zamowienia_aktualne.php"><span>1</span> Klient</a>
					</div>
					<div class="active-step">
						<a><span>2</span> Aktualne zamówienia klienta</a>
					</div>
