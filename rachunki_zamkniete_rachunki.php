<div class='basic-grey'>
    ...
    <?php
        while($row = oci_fetch_array($rachunki)) {
            $id_rachunku = $row['ID'];
            include 'rachunki_zamkniete_rachunki_klient.php';
            include 'rachunki_zamkniete_rachunki_posilki.php';
            include 'rachunki_zamkniete_rachunki_uslugi.php';
            include 'rachunki_zamkniete_rachunki_wypozyczenia.php';
