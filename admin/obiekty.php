				...
				<?php
					while($row = oci_fetch_array($obiekty)) {
						echo"<tr>";
							...
							echo"<td><a href='edit.php?id=".$row['ID']."&tabela=OBIEKTY' title='Edytuj obiekt'><span class='octicon octicon-pencil' style='min-width: 32px;'></span></a></td>";
				...
				<?php
					while($row = oci_fetch_array($typy_obiektow)) {
						echo"<tr>";
							...
							echo"<td><a href='edit.php?id=".$row['NAZWA']."&tabela=TYPY_OBIEKTOW' title='Edytuj typ obiektu'><span class='octicon octicon-pencil' style='min-width: 32px;'></span></a></td>";
