					...
					while($row = oci_fetch_array($pracownicy)) {
						echo"<tbody id='".$row['ID']."'>";
							echo"<tr>";
								...
								echo"<td><a href='edit.php?id=".$row['ID']."&tabela=PRACOWNICY' title='Edytuj pracownika'><span class='octicon octicon-pencil' style='min-width: 32px;'></span></a></td>";
							echo"</tr>";
							echo"<tr>";
								...
								echo"<td><a href='delete.php?id=".$row['ID']."&tabela=PRACOWNICY' title='Usuń pracownika'><span class='octicon octicon-trashcan' style='min-width: 32px;'></span></a></td>";
							echo"</tr>";
						echo"</tbody>";
					}
				?>
					...
					while($row = oci_fetch_array($stanowiska)) {
						echo"<tbody id='".$row['NAZWA']."'>";
							echo"<tr>";
								...
								echo"<td><a href='edit.php?id=".$row['NAZWA']."&tabela=STANOWISKA' title='Edytuj stanowisko'><span class='octicon octicon-pencil' style='min-width: 32px;'></span></a></td>";
								echo"<td><a href='delete.php?nazwa=".$row['NAZWA']."&tabela=STANOWISKA' title='Usuń stanowisko'><span class='octicon octicon-trashcan' style='min-width: 32px;'></span></a></td>";
							echo"</tr>";
						echo"</tbody>";
					}
				?>
